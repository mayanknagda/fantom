...
class TrainerVAE(Trainer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(model, train_dl, val_dl, optimizer, device, exp_path)
    ...
    def _train_one_epoch(self):
        ...
        for batch in self.train_dl:
            ...
            if ("context" in self.model_name) or ("llm" in self.model_name):
                kwargs["doc_emb"] = batch["doc_emb"].to(self.device)
